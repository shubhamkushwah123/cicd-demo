try{
    node{
        ...
        stage('git checkout'){
            ...
            git 'https://www.github.com/shubhamkushwah123/cicd-demo.git'
        }
        ...
        stage('Ansible - Configuring Machines for Deployment'){
            
        }
        stage('Ansible - Configuring and Deploy Application'){
            echo "Executing Ansible playbook..."
            echo "Installing required softwares in the nodes"
            echo "Deploying application..."
            
                ansiblePlaybook become: true, installation: 'ansible', inventory: '/etc/ansible/hosts', playbook: 'ansible-configuration.yml'
